...
dash.register_page(__name__,
                   path='/vehicle-duty-cycle',  # represents the url text
                   name='Vehicle duty cycle',  # name of page, commonly used as name of link
                   title='Vehicle duty cycle'  # epresents the title of browser's tab
)
